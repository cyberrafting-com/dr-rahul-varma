            ...
            <div class="row">
                <div class="col-12 text-center">
                    <div class="banner-section-content">
                        <h1 data-aos="fade-up">Cardiac Disorder</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row services_page_row align-items-start">
            ...
            <div class="col-lg-8 col-md-12 order-1 order-lg-1 services_content_col">
                <div class="service-single-content service-single-stacked">
                    ...
                    <figure class="service-single-figure service-single-figure-sized mb-4" data-aos="fade-up" style="border-radius: 50px 0 !important;">
                        <img src="{{ asset('resources/assets/images/cardiac-disorder.png') }}" alt="Cardiac Disorder" class="img-fluid">
                    </figure>
                    <div class="service-single-body" data-aos="fade-up">
                        <p class="service-single-text">Heart conditions can affect blood flow, rhythm, and overall cardiovascular health. If not managed properly, they can lead to heart attacks, heart failure, or other serious complications. From a doctor’s perspective, early diagnosis, regular monitoring, timely medications, and lifestyle management are essential to maintain a healthy heart.</p>
                        <p class="service-single-text">Dr. Rahul B. Varma provides evidence-based care for cardiac disorders. With extensive experience, we help patients manage heart conditions, reduce risks, and improve heart health through personalized treatment plans.</p>
                        <ul class="service-single-list list-unstyled">
                            <li><i class="fa-solid fa-check" aria-hidden="true"></i> Heart health evaluation & monitoring</li>
                            ...
                            <li><i class="fa-solid fa-check" aria-hidden="true"></i> Prevention of heart attacks & complications</li>
            ...
            <div class="col-lg-4 col-md-12 order-2 order-lg-2 services_sidebar_col">
                @include('partials.services-sidebar', ['active' => 'cardiac'])
            </div>
        </div>
    </div>
</section>
            ...
            <div class="row">
                <div class="col-12" data-aos="fade-right">
                    <div class="subscribe_content text-center">
                        ...
                        <p>Consult Dr. Rahul B. Varma for cardiac disorders. Schedule your appointment now.</p>
